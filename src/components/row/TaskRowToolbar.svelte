<script lang="ts">
  ...
  type Props = Pick<TaskEditable, "id" | "edit"> & {
...
<div class="flex ps-1">
  <button class="btn" onclick={editTask}>
    <svg xmlns="http://www.w3.org/2000/svg" fill={`${edit ? 'currentColor' : 'none'}`} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
